...
float LineSegment::compareLengths_MAX( const LineSegment* segment0, const LineSegment* segment1 )
{
...
float LineSegment::compareLengths( const LineSegment* s0, const LineSegment* s1 )
{
